...
| --- | --- | --- |
| [`@elata-biosciences/create-elata-demo`](https://www.npmjs.com/package/@elata-biosciences/create-elata-demo) | 0.1.9 | Demo scaffolder with rPPG, EEG, and EEG BLE templates |
| [`@elata-biosciences/eeg-web`](https://www.npmjs.com/package/@elata-biosciences/eeg-web) | 0.1.9 | EEG WASM bindings — signal processing, band power, models |
| [`@elata-biosciences/eeg-web-ble`](https://www.npmjs.com/package/@elata-biosciences/eeg-web-ble) | 0.1.9 | Web Bluetooth transport for EEG headband devices |
| [`@elata-biosciences/rppg-web`](https://www.npmjs.com/package/@elata-biosciences/rppg-web) | 0.1.9 | rPPG pipeline — heart rate from camera via face detection |
