...
<AccordionGroup>
  <Accordion title="Trace Snapshots">
    Use `getTraceSnapshot()` when you need recent waveform or debug points for charts,
  ...
  <Accordion title="Video Playback Helper">
    ...
    default. If you need to coordinate that step yourself, call `ensureVideoPlaying()` directly:
