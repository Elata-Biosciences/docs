...
- Add live Muse-compatible transport: [Stream Muse-Compatible EEG Over Web Bluetooth](/sdk/tutorials/eeg-ble-live-stream)
- EEG package reference: [eeg-web](/sdk/eeg-web/getting-started)
- Higher-level integration summary: [EEG In A Browser App](/sdk/guides/eeg-browser)
