...
- Want to build on top of the scaffolded starter: [create-elata-demo reference](/sdk/create-elata-demo)
- Want to integrate EEG into an existing app: [Add EEG To An Existing Browser App](/sdk/tutorials/eeg-existing-app)
- Want live Muse-compatible headset streaming: [Stream Muse-Compatible EEG Over Web Bluetooth](/sdk/tutorials/eeg-ble-live-stream)
- Want camera-based rPPG in an existing app: [Add Camera-Based rPPG To An Existing Browser App](/sdk/tutorials/rppg-existing-app)
