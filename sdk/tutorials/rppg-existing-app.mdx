...
only need the mental model first, use [rPPG In A Browser App](/sdk/guides/rppg-browser).
...
[Build Your First Elata App](/sdk/tutorials/first-app) when you choose the
**existing app** branch for camera rPPG. If you are **extending the scaffold**
instead, stay on `rppg-web-demo` and use
[rPPG In A Browser App](/sdk/guides/rppg-browser) plus [rppg-web](/sdk/rppg-web/getting-started).
...
- rPPG package reference: [rppg-web](/sdk/rppg-web/getting-started)
- Shorter integration guide: [rPPG In A Browser App](/sdk/guides/rppg-browser)
- Best first-time setup path: [Build Your First Elata App](/sdk/tutorials/first-app)
