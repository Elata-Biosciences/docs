---
title: "Stream EEG Over Web Bluetooth"
description: "Build a browser EEG flow that discovers a supported device, connects, and starts receiving frames."
---

This tutorial builds on the browser EEG package and adds live Web Bluetooth transport with `@elata-biosciences/eeg-web-ble`.
...
Once `onFrame` starts firing, move the data into your own app state instead of leaving it only in `console.log`.
...
- EEG transport reference: [eeg-web-ble](/sdk/eeg-web-ble/getting-started)
- EEG runtime reference: [eeg-web](/sdk/eeg-web/getting-started)
- Overview guide: [Web Bluetooth With Supported Devices](/sdk/guides/web-bluetooth)