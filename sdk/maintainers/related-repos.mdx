---
title: "Related Repos"
description: "Developer-facing context for the public Elata protocol repository and package surfaces that matter when working on the SDK."
---

The SDK monorepo is not the whole public developer surface.

If you are maintaining browser integrations, validating real product behavior, or following app-launch flows end to end, you will usually need the public protocol repo alongside this one, plus the published npm package surface:
...
These browser apps are maintained as separate repositories and deploy to GitHub Pages. They are useful when validating real-world integration patterns, UX for neurofeedback, or multi-package composition:
...
Consumer-facing documentation for developers lives on [Example Applications](/sdk/guides/example-apps).
