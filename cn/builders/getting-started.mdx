...
<Warning>
  **Testnet**: Currently on Ethereum Sepolia. Mainnet coming soon. Perfect time to test your launch.
</Warning>

<CardGroup cols={2}>
  <Card title="Launch Guide" icon="rocket" href="/apps/build/launch-your-app">
    5-minute walkthrough
  </Card>
  <Card title="Token Economics" icon="chart-line" href="/apps/design/bonding-curve-basics">
    How pricing works
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Launch Guide" icon="play" href="/apps/build/launch-your-app">
    Full walkthrough
  </Card>
  <Card title="Bonding Curves" icon="chart-line" href="/apps/design/bonding-curve-basics">
    Pricing and graduation
  </Card>
  <Card title="Growth Tools" icon="users" href="/apps/operate/grow-your-community">
    Tournaments and items
  </Card>
  <Card title="API" icon="code" href="/apps/build/overview">
    Integration points
  </Card>
</CardGroup>
