...
<CardGroup cols={2}>
  <Card title="API Overview" icon="code" iconType="light" href="/apps/build/overview">
    Integrate with Elata programmatically
  </Card>
  <Card title="Bonding Curves" icon="chart-line" iconType="light" href="/apps/design/bonding-curve-basics">
