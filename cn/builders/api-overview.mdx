...
#### Premium Content and In-Game Purchases

Apps with a configured content store can use premium ownership and purchase endpoints.
...
Call this after a successful on-chain `purchaseWithToken` transaction.
