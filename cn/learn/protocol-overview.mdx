...
<CardGroup cols={2}>
  <Card title="For Builders" icon="hammer" iconType="light" href="/apps/build/overview">
    Launch your app with a native token in minutes
  </Card>
  <Card title="For Users" icon="user" iconType="light" href="/apps/users/explore-apps">
...
<CardGroup cols={3}>
  ...
  <Card title="Launch an App" icon="rocket" iconType="light" href="/apps/build/launch-your-app">
