...
Elata EEG is an **open-source electroencephalography platform** built around a Raspberry Pi 5 and the Texas Instruments ADS1299 analog front-end. The goal is to democratize EEG hardware with a fully open, right-to-repair design that any lab or hacker can build, modify, and extend.
...
<Card title="GitHub Repository" icon="github" href="https://github.com/Elata-Biosciences/elata-eeg">
...
<CardGroup cols={2}>
  <Card title="Architecture" icon="diagram-project" href="/home/elata-eeg/eeg-architecture">
    Crate layering, plugin system, and WebSocket API
  </Card>
  <Card title="SDK — eeg-web" icon="microchip" href="/sdk/eeg-web/getting-started">
