...
<CardGroup cols={2}>
  <Card title="EEG Overview" icon="brain" href="/home/elata-eeg/elata-eeg-overview">
    Hardware BOM and quickstart
  </Card>
  <Card title="SDK — eeg-web-ble" icon="bluetooth" href="/sdk/eeg-web-ble/getting-started">
