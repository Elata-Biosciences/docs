...
| \$ELTA stakers | Tournament fees enter Elata's fee pipeline and are routed by current fee-kind policy (including treasury and app contributor flows). <br />This ties user activity directly to ecosystem funding and contributor incentives. |
